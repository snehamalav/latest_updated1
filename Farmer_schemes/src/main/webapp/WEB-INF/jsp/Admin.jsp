...
h3 {color:antiquewhite; font-size:28px;margin-bottom:24px;}
    ...
    <body>  
            ...
            <div class="topnav">
                  ...
                  <input type="submit" value="View All Farmer Request" ></form>
                  <form action="viewbidder.do" method="get">
                  <input type="submit" value="View ALl Bidder Request " ></form>
                  <form action="searchfarmer.do" method="get">
                  <input type="submit" value="Search Farmer to Approve" ></form>
                  <form action="searchbidder.do" method="get">
                  <input type="submit" value="Search Bidder to Approve" ></form>
